...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/realestate-com-au/pact".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<pact-mock_service>.freeze, ["~> 1.2"])
      ...
      s.add_dependency(%q<pact-mock_service>.freeze, ["~> 1.2"])
